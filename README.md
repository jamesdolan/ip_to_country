# 🌎 ip_to_country
Rewrite of [IPToCC](https://github.com/roniemartinez/IPToCC) with an emphesis on performance (>10000x faster queries!) and memory reduction (98% less!), with no external dependencies and database that is updated nightly. Designed to be blazing fast on even the smallest VPS cloud instances.
