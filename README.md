# 🌎 ip_to_country
Rewrite of [IPToCC](https://github.com/roniemartinez/IPToCC) with an emphesis on performance (~22000x faster!) and memory reduction (98% less!), with no external dependencies and database thats updated nightly.
